...
public class Project extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cnameCombo = new javax.swing.JComboBox();
        ...
        cnameCombo.setFont(new java.awt.Font("Comic Sans MS", 0, 12)); // NOI18N
        cnameCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cnameCombo, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(128, 128, 128))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(c_nameLabel)
                    .addComponent(cnameCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(p_nameLabel)
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        String cname,pname,address,details ;
        int flag=0;
       if(cnameCombo.getSelectedItem().equals("Select") )
    {
        JOptionPane.showMessageDialog(null,"Select Customer Name");
        flag++;
    }
    ...
    if(flag==0)
         {  
             cname = (String) cnameCombo.getSelectedItem();
             ...
             try {
                  ...
                  PreparedStatement prp=con.prepareStatement("insert into Project (PRONAME,CUSTNAME,ADDRESS,DETAILS,PRODATE) values(?,?,?,?,?)");    
                        ...
                        prp.executeUpdate(); 
                         ...
                         cnameCombo.setSelectedItem("Select");
    ...
    private javax.swing.JComboBox cnameCombo;
